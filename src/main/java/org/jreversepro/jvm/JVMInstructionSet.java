...
public class JVMInstructionSet implements Opcodes
{
	 ...
	 *
	 * @param opcode Index of the Opcode
	...
	private static void assign14()
	{
		...
		/*sOpCode[OPCODE_GGETCLASS] = "ggetclass";
		sLength[OPCODE_GGETCLASS] = 3;

		sOpCode[OPCODE_GGETNULL] = "ggetnull";
		sLength[OPCODE_GGETNULL] = 3;

		sOpCode[OPCODE_GDEFINE] = "gdefine";
		sLength[OPCODE_GDEFINE] = 5;  */
