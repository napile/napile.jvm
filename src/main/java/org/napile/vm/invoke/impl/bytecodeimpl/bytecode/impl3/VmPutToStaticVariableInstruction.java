 ...
 * @date 19:59/21.09.12
 */
public class VmPutToStaticVariableInstruction extends VmInstruction<PutToStaticVariableInstruction>
{
	private FqName className;
	private String name;

	public VmPutToStaticVariableInstruction(PutToStaticVariableInstruction instruction)
	{
		super(instruction);
